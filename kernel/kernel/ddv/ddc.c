...
static int __init function_start( void ) {
	...
	ret = register_chrdev_region( dispositivo, 1,  "ESCOM_DDC" );
...
Generar un archivo de dispositivo en /dev
para comunicarse desde espacio usuario

1. Crear numeros mayores y menores /proc/devices/
2. Nombre del archivo sudo mknod -m 660 /dev/ESCOM_dev c 135 0
														 may menor
3.														 
