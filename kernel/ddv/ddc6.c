/*
*  ddc6.c Algoritmo de autocorrelación utilizando un archivo de dispositivo 
*
*/
...
static ssize_t driver_write( struct file *filp, const char * buf, size_t len, loff_t * off) {
	...
	for( i = 0; i < MAX_SIZE; i++ )
		printk( KERN_INFO "Muestra write %d : %d \n", i, rxx[i] );
...
void procesamiento ( void ) { /*Correlación discreta*/
	register int n, l = 0;
